...
TARGET_KERNEL_SOURCE := $(COMMON_PATH)-kernel/kernel-headers
BOARD_PREBUILT_DTBIMAGE_DIR := $(COMMON_PATH)-kernel
BOARD_MKBOOTIMG_ARGS += --dtb $(BOARD_PREBUILT_DTBIMAGE_DIR)/sm8250-dtb.img
